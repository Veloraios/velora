document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileConfigFiles = [
        ...
        'tweaks/thirdpartystores/Acutus.mobileconfig',
        'tweaks/thirdpartystores/AltList.mobileconfig',
        'tweaks/thirdpartystores/App Valley.mobileconfig',
        'tweaks/thirdpartystores/AppBox.mobileconfig',
        'tweaks/thirdpartystores/AppDB Valley.mobileconfig',
        'tweaks/thirdpartystores/Carnage ipas.mobileconfig',
        'tweaks/thirdpartystores/CoolStore.mobileconfig',
        'tweaks/thirdpartystores/EonHub.mobileconfig',
        'tweaks/thirdpartystores/FabricSign.mobileconfig',
        'tweaks/thirdpartystores/Flekstore.mobileconfig',
        'tweaks/thirdpartystores/iOS Ninja.mobileconfig',
        'tweaks/thirdpartystores/iOSGods.mobileconfig',
        'tweaks/thirdpartystores/iTweakHub.mobileconfig',
        'tweaks/thirdpartystores/JB iPAS Store.mobileconfig',
        'tweaks/thirdpartystores/Lunar Cheats.mobileconfig',
        'tweaks/thirdpartystores/Misaka Store.mobileconfig',
        'tweaks/thirdpartystores/Nexara.mobileconfig',
        'tweaks/thirdpartystores/Panda Helper.mobileconfig',
        'tweaks/thirdpartystores/Quorix.mobileconfig',
        'tweaks/thirdpartystores/TrollApps.mobileconfig',
        'tweaks/thirdpartystores/Velixa.mobileconfig',
        'tweaks/thirdpartystores/Zeus.mobileconfig',


    ];

    function createMobileConfigButtons() {
        const virtualJailbreaksDiv = document.getElementById('third-party-store');
        
        mobileConfigFiles.forEach((filePath, index) => {
            const button = document.createElement('button');
            button.classList.add('nav-button');
            button.setAttribute('data-section', 'third-party-store');
            button.innerHTML = `
