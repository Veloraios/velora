document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileConfigFiles = [
        'tweaks/packagemanagers/Cydia 2.mobileconfig',
        'tweaks/packagemanagers/Cydia Dark.mobileconfig',
    ...
    function createMobileConfigButtons() {
        const virtualJailbreaksDiv = document.getElementById('package-managers');
