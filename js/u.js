document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileConfigFiles = [
        'tweaks/utilities/2FA.mobileconfig',
        'tweaks/utilities/AltSource Browser.mobileconfig',
        'tweaks/utilities/AltSource Maker.mobileconfig',
        'tweaks/utilities/Apple DB.mobileconfig',
        'tweaks/utilities/ArmConverter.mobileconfig',
        'tweaks/utilities/Beta Profiles.mobileconfig',
        'tweaks/utilities/Calculator.mobileconfig',
        'tweaks/utilities/Fake Update.mobileconfig',
        'tweaks/utilities/iConfig.mobileconfig',
        'tweaks/utilities/iDevice Info.mobileconfig',
        'tweaks/utilities/iPA Installer.mobileconfig',
        'tweaks/utilities/iPA Signer (free).mobileconfig',
        'tweaks/utilities/iPA Signer (paid).mobileconfig',
        'tweaks/utilities/iPod.mobileconfig',
        'tweaks/utilities/Profile Maker.mobileconfig',
        'tweaks/utilities/Remote For Slides.mobileconfig',
        'tweaks/utilities/XBox Cloud Gaming.mobileconfig'
    ...
    function createMobileConfigButtons() {
        const virtualJailbreaksDiv = document.getElementById('utilities');
        
        mobileConfigFiles.forEach((filePath, index) => {
            const button = document.createElement('button');
            button.classList.add('nav-button');
            button.setAttribute('data-section', 'utilities');
            button.innerHTML = `
